...
|AVG_RANGE_ROWS|Average number of rows with duplicate column values within a histogram step  (RANGE_ROWS / DISTINCT_RANGE_ROWS  excluding the upper bound for DISTINCT_RANGE_ROWS > 0).| 
